    ...
    <>
      ...
      <main>
        ...
        <footer className="footer-section">
          ...
          <div className="inviyu-credit">
            <p className="credit-title">Invitation by inviyu</p>
